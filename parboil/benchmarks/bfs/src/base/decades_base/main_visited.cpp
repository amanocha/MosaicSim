...
__attribute__((noinline)) void _kernel_compute(Node *h_graph_nodes, Edge *h_graph_edges, int *color, int *h_cost, int source, int tid, int num_threads)
{
...
__attribute__((noinline)) void _kernel_supply(Node *h_graph_nodes, Edge *h_graph_edges, int *color, int *h_cost, int source, int tid, int num_threads)
{
    std::deque<int> wavefront;
    wavefront.push_back(source);
    color[source] = 16677218;
...
void runCPU( int argc, char** argv)
{
 ...
 _kernel_compute(h_graph_nodes,h_graph_edges,color,h_cost,source,DECADES_tid,1);
