...
define dso_local void @_Z7BFS_CPUP4NodeP4EdgePiS3_i(%struct.Node* nocapture readonly %h_graph_nodes, %struct.Edge* nocapture readonly %h_graph_edges, i32* nocapture %color, i32* nocapture %h_cost, i32 %source) local_unnamed_addr #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  ...
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 %0, i8 0, i64 80, i1 false) #6
...
if.then.i.i.i:                                    ; preds = %if.else.i
  ...
  %11 = load i32**, i32*** %_M_node3.i, align 8, !tbaa !16
...
if.then.i.i.i.i.i:                                ; preds = %if.then14.i
  ...
  call void @llvm.memmove.p0i8.p0i8.i64(i8* align 8 %12, i8* align 8 %13, i64 %sub.ptr.sub.i.i.i.i.i, i1 false) #6
  br label %.noexc
...
if.then.i.i.i.i101.i:                             ; preds = %if.else.i48
  ...
  call void @llvm.memmove.p0i8.p0i8.i64(i8* align 8 %14, i8* align 8 %15, i64 %sub.ptr.sub.i.i.i.i.i, i1 false) #6
  br label %.noexc
...
call2.i.i3.i.i.noexc:                             ; preds = %_ZNSt11_Deque_baseIiSaIiEE15_M_allocate_mapEm.exit.i
  ...
  %17 = load i32**, i32*** %_M_node3.i, align 8, !tbaa !16
  %18 = load i32**, i32*** %_M_node.i.i.i, align 8, !tbaa !14
...
if.then.i.i.i.i107.i:                             ; preds = %call2.i.i3.i.i.noexc
  ...
  call void @llvm.memmove.p0i8.p0i8.i64(i8* nonnull align 8 %19, i8* align 8 %20, i64 %sub.ptr.sub.i.i.i.i104.i, i1 false) #6
...
_ZSt4copyIPPiS1_ET0_T_S3_S2_.exit109.i:           ; preds = %if.then.i.i.i.i107.i, %call2.i.i3.i.i.noexc
  ...
  store i8* %call2.i.i3.i.i51, i8** %21, align 8, !tbaa !15
  store i64 %add38.i, i64* %_M_map_size.i.i.i, align 8, !tbaa !13
  br label %.noexc
...
.noexc:                                           ; preds = %_ZSt4copyIPPiS1_ET0_T_S3_S2_.exit109.i, %if.then.i.i.i.i101.i, %if.else.i48, %if.then.i.i.i.i.i, %if.then14.i
  ...
  store i32** %__new_nstart.0.i, i32*** %_M_node3.i, align 8, !tbaa !17
  %23 = load i32*, i32** %__new_nstart.0.i, align 8, !tbaa !18
  %_M_first.i92.i = getelementptr inbounds %"class.std::deque", %"class.std::deque"* %wavefront, i64 0, i32 0, i32 0, i32 2, i32 1
  store i32* %23, i32** %_M_first.i92.i, align 8, !tbaa !19
  ...
  store i32* %add.ptr.i93.i, i32** %_M_last.i94.i, align 8, !tbaa !20
  %add.ptr71.i = getelementptr inbounds i32*, i32** %__new_nstart.0.i, i64 %sub.ptr.div.i
  store i32** %add.ptr71.i, i32*** %_M_node.i.i.i, align 8, !tbaa !17
  %24 = load i32*, i32** %add.ptr71.i, align 8, !tbaa !18
  %_M_first.i.i = getelementptr inbounds %"class.std::deque", %"class.std::deque"* %wavefront, i64 0, i32 0, i32 0, i32 3, i32 1
  store i32* %24, i32** %_M_first.i.i, align 8, !tbaa !19
  %add.ptr.i.i49 = getelementptr inbounds i32, i32* %24, i64 128
  store i32* %add.ptr.i.i49, i32** %_M_last.i, align 8, !tbaa !20
...
while.body:                                       ; preds = %while.body.lr.ph, %for.cond.cleanup
  ...
  %41 = load i32*, i32** %_M_last.i55, align 8, !tbaa !22
...
invoke.cont.i:                                    ; preds = %while.body
  ...
  store i32* %incdec.ptr.i58, i32** %_M_cur1.i.i, align 8, !tbaa !23
  br label %_ZNSt5dequeIiSaIiEE9pop_frontEv.exit

if.else.i63:                                      ; preds = %while.body
  %42 = load i8*, i8** %33, align 8, !tbaa !24
  call void @_ZdlPv(i8* %42) #6
  %43 = load i32**, i32*** %_M_node.i.i, align 8, !tbaa !16
  %add.ptr.i.i60 = getelementptr inbounds i32*, i32** %43, i64 1
  store i32** %add.ptr.i.i60, i32*** %_M_node.i.i, align 8, !tbaa !17
  %44 = load i32*, i32** %add.ptr.i.i60, align 8, !tbaa !18
  store i32* %44, i32** %_M_first.i.i59, align 8, !tbaa !19
  %add.ptr.i.i.i61 = getelementptr inbounds i32, i32* %44, i64 128
  store i32* %add.ptr.i.i.i61, i32** %_M_last.i55, align 8, !tbaa !20
  %.cast.i.i62 = ptrtoint i32* %44 to i64
  store i64 %.cast.i.i62, i64* %34, align 8, !tbaa !23
  br label %_ZNSt5dequeIiSaIiEE9pop_frontEv.exit
...
_ZNSt5dequeIiSaIiEE9pop_frontEv.exit:             ; preds = %invoke.cont.i, %if.else.i63
  ...
  %46 = load i32, i32* %y, align 4, !tbaa !25
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %_ZNSt5dequeIiSaIiEE9pop_frontEv.exit
  ...
  store i32 16677221, i32* %arrayidx25, align 4, !tbaa !11
  %50 = load i32*, i32** %_M_cur.i, align 8, !tbaa !21
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end
  ...
  %54 = load i32, i32* %x11, align 4, !tbaa !28
  %idxprom12 = sext i32 %54 to i64
  %arrayidx13 = getelementptr inbounds i32, i32* %color, i64 %idxprom12
  %55 = load i32, i32* %arrayidx13, align 4, !tbaa !11
  %cmp14 = icmp eq i32 %55, 16677217
  br i1 %cmp14, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %56 = load i32, i32* %arrayidx16, align 4, !tbaa !11
  %add17 = add nsw i32 %56, 1
  %arrayidx19 = getelementptr inbounds i32, i32* %h_cost, i64 %idxprom12
  store i32 %add17, i32* %arrayidx19, align 4, !tbaa !11
  %57 = load i32*, i32** %_M_cur.i, align 8, !tbaa !2
  %58 = load i32*, i32** %_M_last.i, align 8, !tbaa !10
...
if.then.i69:                                      ; preds = %if.then
  ...
  store i32* %incdec.ptr.i68, i32** %_M_cur.i, align 8, !tbaa !2
  br label %invoke.cont21

if.else.i76:                                      ; preds = %if.then
  %59 = load i64, i64* %_M_map_size.i.i.i70, align 8, !tbaa !13
  %60 = load i64, i64* %35, align 8, !tbaa !14
  %61 = load i64, i64* %36, align 8, !tbaa !15
...
if.then.i.i.i77:                                  ; preds = %if.else.i76
  %64 = load i32**, i32*** %_M_node.i.i, align 8, !tbaa !16
...
if.then.i.i.i.i.i112:                             ; preds = %if.then14.i111
  ...
  call void @llvm.memmove.p0i8.p0i8.i64(i8* align 8 %65, i8* align 8 %66, i64 %sub.ptr.sub.i.i.i.i.i108, i1 false) #6
  br label %.noexc86
...
if.then.i.i.i.i101.i118:                          ; preds = %if.else.i113
  ...
  call void @llvm.memmove.p0i8.p0i8.i64(i8* align 8 %67, i8* align 8 %68, i64 %sub.ptr.sub.i.i.i.i.i108, i1 false) #6
  br label %.noexc86
...
call2.i.i3.i.i.noexc147:                          ; preds = %_ZNSt11_Deque_baseIiSaIiEE15_M_allocate_mapEm.exit.i135
  ...
  %70 = load i32**, i32*** %_M_node.i.i, align 8, !tbaa !16
  %71 = load i32**, i32*** %_M_node.i.i.i71, align 8, !tbaa !14
...
if.then.i.i.i.i107.i136:                          ; preds = %call2.i.i3.i.i.noexc147
  ...
  call void @llvm.memmove.p0i8.p0i8.i64(i8* nonnull align 8 %72, i8* align 8 %73, i64 %sub.ptr.sub.i.i.i.i104.i133, i1 false) #6
...
_ZSt4copyIPPiS1_ET0_T_S3_S2_.exit109.i137:        ; preds = %if.then.i.i.i.i107.i136, %call2.i.i3.i.i.noexc147
  %74 = load i8*, i8** %37, align 8, !tbaa !15
  call void @_ZdlPv(i8* %74) #6
  store i8* %call2.i.i3.i.i148, i8** %37, align 8, !tbaa !15
  store i64 %add38.i122, i64* %_M_map_size.i.i.i70, align 8, !tbaa !13
  br label %.noexc86
...
.noexc86:                                         ; preds = %_ZSt4copyIPPiS1_ET0_T_S3_S2_.exit109.i137, %if.then.i.i.i.i101.i118, %if.else.i113, %if.then.i.i.i.i.i112, %if.then14.i111
  ...
  store i32** %__new_nstart.0.i138, i32*** %_M_node.i.i, align 8, !tbaa !17
  %75 = load i32*, i32** %__new_nstart.0.i138, align 8, !tbaa !18
  store i32* %75, i32** %_M_first.i.i59, align 8, !tbaa !19
  %add.ptr.i93.i140 = getelementptr inbounds i32, i32* %75, i64 128
  store i32* %add.ptr.i93.i140, i32** %_M_last.i55, align 8, !tbaa !20
  %add.ptr71.i142 = getelementptr inbounds i32*, i32** %__new_nstart.0.i138, i64 %sub.ptr.div.i95
  store i32** %add.ptr71.i142, i32*** %_M_node.i.i.i71, align 8, !tbaa !17
  %76 = load i32*, i32** %add.ptr71.i142, align 8, !tbaa !18
  store i32* %76, i32** %_M_first.i.i143, align 8, !tbaa !19
  %add.ptr.i.i144 = getelementptr inbounds i32, i32* %76, i64 128
  store i32* %add.ptr.i.i144, i32** %_M_last.i, align 8, !tbaa !20
...
call2.i.i.i.i.i.noexc87:                          ; preds = %_ZNSt5dequeIiSaIiEE16_M_push_back_auxIJRKiEEEvDpOT_.exit.i85
  %77 = load i32**, i32*** %_M_node.i.i.i71, align 8, !tbaa !14
  %add.ptr.i.i79 = getelementptr inbounds i32*, i32** %77, i64 1
  %78 = bitcast i32** %add.ptr.i.i79 to i8**
  store i8* %call2.i.i.i.i.i88, i8** %78, align 8, !tbaa !18
  %79 = load i32*, i32** %_M_cur.i.i80, align 8, !tbaa !2
  store i32 %54, i32* %79, align 4, !tbaa !11
  %80 = load i32**, i32*** %_M_node.i.i.i71, align 8, !tbaa !14
  %add.ptr11.i.i81 = getelementptr inbounds i32*, i32** %80, i64 1
  store i32** %add.ptr11.i.i81, i32*** %_M_node.i.i.i71, align 8, !tbaa !17
  %81 = load i32*, i32** %add.ptr11.i.i81, align 8, !tbaa !18
  store i32* %81, i32** %_M_first.i.i143, align 8, !tbaa !19
  %add.ptr.i.i.i83 = getelementptr inbounds i32, i32* %81, i64 128
  store i32* %add.ptr.i.i.i83, i32** %_M_last.i, align 8, !tbaa !20
  %.cast.i.i84 = ptrtoint i32* %81 to i64
  store i64 %.cast.i.i84, i64* %38, align 8, !tbaa !2
  br label %invoke.cont21

invoke.cont21:                                    ; preds = %call2.i.i.i.i.i.noexc87, %if.then.i69
  store i32 16677218, i32* %arrayidx13, align 4, !tbaa !11
  %.pre = load i32, i32* %y, align 4, !tbaa !25
  %.pre179 = load i32, i32* %x, align 4, !tbaa !27
  br label %if.end
...
while.end:                                        ; preds = %for.cond.cleanup, %invoke.cont
  ...
  %85 = load i32**, i32*** %_M_map.i.i, align 8, !tbaa !15
...
_ZNSt11_Deque_baseIiSaIiEE16_M_destroy_nodesEPPiS3_.exit.loopexit.i.i: ; preds = %for.body.i.i.i
  ...
  %.pre.i.i = load i8*, i8** %.phi.trans.insert.i.i, align 8, !tbaa !15
...
ehcleanup:                                        ; preds = %lpad20.loopexit, %lpad20.loopexit.split-lp, %lpad
  ...
  %92 = load i32**, i32*** %_M_map.i.i153, align 8, !tbaa !15
...
_ZNSt11_Deque_baseIiSaIiEE16_M_destroy_nodesEPPiS3_.exit.loopexit.i.i166: ; preds = %for.body.i.i.i163
  ...
  %.pre.i.i165 = load i8*, i8** %.phi.trans.insert.i.i164, align 8, !tbaa !15
...
entry:
  store i32 0, i32* @no_of_nodes, align 4, !tbaa !11
  store i32 0, i32* @edge_list_size, align 4, !tbaa !11
...
entry:
  ...
  store i32 %argc, i32* %argc.addr, align 4, !tbaa !11
  %0 = bitcast %struct.pb_TimerSet* %timers to i8*
  call void @llvm.lifetime.start.p0i8(i64 288, i8* nonnull %0) #6
  ...
  %1 = load i8**, i8*** %inpFiles, align 8, !tbaa !30
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %3 = load i8*, i8** %arrayidx2, align 8, !tbaa !18
  %cmp3 = icmp eq i8* %3, null
  br i1 %cmp3, label %if.end, label %if.then

if.then:                                          ; preds = %lor.lhs.false, %entry
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !18
  %5 = call i64 @fwrite(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i64 0, i64 0), i64 29, i64 1, %struct._IO_FILE* %4) #12
  call void @exit(i32 -1) #13
  unreachable

if.end:                                           ; preds = %lor.lhs.false
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %timers, i32 1)
  %6 = load i8**, i8*** %inpFiles, align 8, !tbaa !30
  %7 = load i8*, i8** %6, align 8, !tbaa !18
  %call7 = call %struct._IO_FILE* @fopen(i8* %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  store %struct._IO_FILE* %call7, %struct._IO_FILE** @fp, align 8, !tbaa !18
...
if.end10:                                         ; preds = %if.end
  ...
  %call11 = call i32 (%struct._IO_FILE*, i8*, ...) @fscanf(%struct._IO_FILE* nonnull %call7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* nonnull @no_of_nodes)
  %9 = load i32, i32* @no_of_nodes, align 4, !tbaa !11
  %conv = sext i32 %9 to i64
  %mul = shl nsw i64 %conv, 3
  %call12 = call noalias i8* @malloc(i64 %mul) #6
  %10 = bitcast i8* %call12 to %struct.Node*
  %mul14 = shl nsw i64 %conv, 2
  %call15 = call noalias i8* @malloc(i64 %mul14) #6
  %11 = bitcast i8* %call15 to i32*
  %12 = bitcast i32* %start to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %12) #6
  %13 = bitcast i32* %edgeno to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %13) #6
  %cmp16132 = icmp eq i32 %9, 0
  %14 = load %struct._IO_FILE*, %struct._IO_FILE** @fp, align 8, !tbaa !18
  br i1 %cmp16132, label %for.cond.cleanup, label %for.body

for.cond.cleanup:                                 ; preds = %for.body, %if.end10
  %.lcssa125 = phi %struct._IO_FILE* [ %14, %if.end10 ], [ %26, %for.body ]
  %call23 = call i32 (%struct._IO_FILE*, i8*, ...) @fscanf(%struct._IO_FILE* %.lcssa125, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* nonnull %source)
  %15 = load %struct._IO_FILE*, %struct._IO_FILE** @fp, align 8, !tbaa !18
  %call24 = call i32 (%struct._IO_FILE*, i8*, ...) @fscanf(%struct._IO_FILE* %15, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* nonnull @edge_list_size)
  %16 = bitcast i32* %id to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %16) #6
  %17 = bitcast i32* %cost to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %17) #6
  %18 = load i32, i32* @edge_list_size, align 4, !tbaa !11
  %conv25 = sext i32 %18 to i64
  %mul26 = shl nsw i64 %conv25, 3
  %call27 = call noalias i8* @malloc(i64 %mul26) #6
  %19 = bitcast i8* %call27 to %struct.Edge*
  %cmp30130 = icmp sgt i32 %18, 0
  %20 = load %struct._IO_FILE*, %struct._IO_FILE** @fp, align 8, !tbaa !18
...
for.body:                                         ; preds = %if.end10, %for.body
  ...
  %21 = phi %struct._IO_FILE* [ %26, %for.body ], [ %14, %if.end10 ]
  %call17 = call i32 (%struct._IO_FILE*, i8*, ...) @fscanf(%struct._IO_FILE* %21, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i64 0, i64 0), i32* nonnull %start, i32* nonnull %edgeno)
  %22 = load i32, i32* %start, align 4, !tbaa !11
  %x = getelementptr inbounds %struct.Node, %struct.Node* %10, i64 %indvars.iv141, i32 0
  store i32 %22, i32* %x, align 4, !tbaa !27
  %23 = load i32, i32* %edgeno, align 4, !tbaa !11
  %y = getelementptr inbounds %struct.Node, %struct.Node* %10, i64 %indvars.iv141, i32 1
  store i32 %23, i32* %y, align 4, !tbaa !25
  %arrayidx22 = getelementptr inbounds i32, i32* %11, i64 %indvars.iv141
  store i32 16677217, i32* %arrayidx22, align 4, !tbaa !11
  %indvars.iv.next142 = add nuw nsw i64 %indvars.iv141, 1
  %24 = load i32, i32* @no_of_nodes, align 4, !tbaa !11
  %25 = zext i32 %24 to i64
  %cmp16 = icmp ult i64 %indvars.iv.next142, %25
  %26 = load %struct._IO_FILE*, %struct._IO_FILE** @fp, align 8, !tbaa !18
  br i1 %cmp16, label %for.body, label %for.cond.cleanup

for.cond.cleanup31:                               ; preds = %for.body32, %for.cond.cleanup
  %.lcssa = phi %struct._IO_FILE* [ %20, %for.cond.cleanup ], [ %33, %for.body32 ]
...
for.body32:                                       ; preds = %for.cond.cleanup, %for.body32
  ...
  %27 = phi %struct._IO_FILE* [ %33, %for.body32 ], [ %20, %for.cond.cleanup ]
  %call33 = call i32 (%struct._IO_FILE*, i8*, ...) @fscanf(%struct._IO_FILE* %27, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* nonnull %id)
  %28 = load %struct._IO_FILE*, %struct._IO_FILE** @fp, align 8, !tbaa !18
  %call34 = call i32 (%struct._IO_FILE*, i8*, ...) @fscanf(%struct._IO_FILE* %28, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* nonnull %cost)
  %29 = load i32, i32* %id, align 4, !tbaa !11
  %x37 = getelementptr inbounds %struct.Edge, %struct.Edge* %19, i64 %indvars.iv139, i32 0
  store i32 %29, i32* %x37, align 4, !tbaa !28
  %30 = load i32, i32* %cost, align 4, !tbaa !11
  %y40 = getelementptr inbounds %struct.Edge, %struct.Edge* %19, i64 %indvars.iv139, i32 1
  store i32 %30, i32* %y40, align 4, !tbaa !32
  %indvars.iv.next140 = add nuw nsw i64 %indvars.iv139, 1
  %31 = load i32, i32* @edge_list_size, align 4, !tbaa !11
  %32 = sext i32 %31 to i64
  %cmp30 = icmp slt i64 %indvars.iv.next140, %32
  %33 = load %struct._IO_FILE*, %struct._IO_FILE** @fp, align 8, !tbaa !18
...
if.end47:                                         ; preds = %for.cond.cleanup31, %if.then45
  %34 = load i32, i32* @no_of_nodes, align 4, !tbaa !11
  %conv48 = sext i32 %34 to i64
  %mul49 = shl nsw i64 %conv48, 2
  %call50 = call noalias i8* @malloc(i64 %mul49) #6
  %35 = bitcast i8* %call50 to i32*
  %cmp53128 = icmp sgt i32 %34, 0
...
for.cond.cleanup54:                               ; preds = %for.body55, %if.end47
  %36 = load i32, i32* %source, align 4, !tbaa !11
  %idxprom61 = sext i32 %36 to i64
  %arrayidx62 = getelementptr inbounds i32, i32* %35, i64 %idxprom61
  store i32 0, i32* %arrayidx62, align 4, !tbaa !11
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %timers, i32 6)
  %37 = load i32, i32* %source, align 4, !tbaa !11
  call void @_Z7BFS_CPUP4NodeP4EdgePiS3_i(%struct.Node* %10, %struct.Edge* %19, i32* %11, i32* %35, i32 %37)
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %timers, i32 1)
  %outFile = getelementptr inbounds %struct.pb_Parameters, %struct.pb_Parameters* %call, i64 0, i32 0
  %38 = load i8*, i8** %outFile, align 8, !tbaa !33
  %cmp63 = icmp eq i8* %38, null
...
for.body55:                                       ; preds = %for.body55, %for.body55.preheader
  ...
  %arrayidx57 = getelementptr inbounds i32, i32* %35, i64 %indvars.iv137
  store i32 2147483647, i32* %arrayidx57, align 4, !tbaa !11
...
if.then64:                                        ; preds = %for.cond.cleanup54
  %call66 = call %struct._IO_FILE* @fopen(i8* nonnull %38, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i64 0, i64 0))
  %39 = load i32, i32* @no_of_nodes, align 4, !tbaa !11
  %call67 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %call66, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i64 0, i64 0), i32 %39)
  %40 = load i32, i32* @no_of_nodes, align 4, !tbaa !11
  %cmp70126 = icmp sgt i32 %40, 0
...
for.body72:                                       ; preds = %if.then64, %for.body72
  ...
  %arrayidx74 = getelementptr inbounds i32, i32* %35, i64 %indvars.iv
  %41 = load i32, i32* %arrayidx74, align 4, !tbaa !11
  %42 = trunc i64 %indvars.iv to i32
  %call75 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %call66, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.7, i64 0, i64 0), i32 %42, i32 %41)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %43 = load i32, i32* @no_of_nodes, align 4, !tbaa !11
  %44 = sext i32 %43 to i64
  %cmp70 = icmp slt i64 %indvars.iv.next, %44
  br i1 %cmp70, label %for.body72, label %for.cond.cleanup71

if.end80:                                         ; preds = %for.cond.cleanup54, %for.cond.cleanup71
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %timers, i32 6)
  call void @free(i8* %call12) #6
  call void @free(i8* %call27) #6
  call void @free(i8* %call15) #6
  call void @free(i8* nonnull %call50) #6
...
cleanup:                                          ; preds = %if.end80, %if.then8
  call void @llvm.lifetime.end.p0i8(i64 288, i8* nonnull %0) #6
  ret void
}

declare dso_local void @pb_InitializeTimerSet(%struct.pb_TimerSet*) local_unnamed_addr #3

declare dso_local %struct.pb_Parameters* @pb_ReadParameters(i32*, i8**) local_unnamed_addr #3
...
declare dso_local void @pb_SwitchToTimer(%struct.pb_TimerSet*, i32) local_unnamed_addr #3

; Function Attrs: nounwind
declare dso_local noalias %struct._IO_FILE* @fopen(i8* nocapture readonly, i8* nocapture readonly) local_unnamed_addr #4

; Function Attrs: nounwind
declare dso_local i32 @fscanf(%struct._IO_FILE* nocapture, i8* nocapture readonly, ...) local_unnamed_addr #4
...
declare dso_local void @pb_PrintTimerSet(%struct.pb_TimerSet*) local_unnamed_addr #3

declare dso_local void @pb_FreeParameters(%struct.pb_Parameters*) local_unnamed_addr #3
...
entry:
  ...
  store i64 %.sroa.speculated, i64* %_M_map_size, align 8, !tbaa !13
...
_ZNSt11_Deque_baseIiSaIiEE15_M_allocate_mapEm.exit: ; preds = %entry
  ...
  store i8* %call2.i.i3.i, i8** %3, align 8, !tbaa !15
  %4 = load i64, i64* %_M_map_size, align 8, !tbaa !13
  %sub = sub i64 %4, %add
...
invoke.cont.i:                                    ; preds = %for.body.i
  ...
  store i8* %call2.i.i.i12.i, i8** %5, align 8, !tbaa !18
...
try.cont:                                         ; preds = %invoke.cont.i
  ...
  store i32** %add.ptr, i32*** %_M_node.i54, align 8, !tbaa !17
  %19 = load i32*, i32** %add.ptr, align 8, !tbaa !18
  %_M_first.i55 = getelementptr inbounds %"class.std::_Deque_base", %"class.std::_Deque_base"* %this, i64 0, i32 0, i32 2, i32 1
  store i32* %19, i32** %_M_first.i55, align 8, !tbaa !19
  ...
  store i32* %add.ptr.i56, i32** %_M_last.i57, align 8, !tbaa !20
  ...
  store i32** %add.ptr27, i32*** %_M_node.i, align 8, !tbaa !17
  %20 = load i32*, i32** %add.ptr27, align 8, !tbaa !18
  %_M_first.i = getelementptr inbounds %"class.std::_Deque_base", %"class.std::_Deque_base"* %this, i64 0, i32 0, i32 3, i32 1
  store i32* %20, i32** %_M_first.i, align 8, !tbaa !19
  ...
  store i32* %add.ptr.i, i32** %_M_last.i, align 8, !tbaa !20
  ...
  store i32* %add.ptr36, i32** %_M_cur39, align 8, !tbaa !2
  ret void
...
attributes #9 = { nobuiltin "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!2 = !{!3, !5, i64 48}
!3 = !{!"_ZTSSt11_Deque_baseIiSaIiEE", !4, i64 0}
!4 = !{!"_ZTSNSt11_Deque_baseIiSaIiEE11_Deque_implE", !5, i64 0, !8, i64 8, !9, i64 16, !9, i64 48}
!5 = !{!"any pointer", !6, i64 0}
!6 = !{!"omnipotent char", !7, i64 0}
!7 = !{!"Simple C++ TBAA"}
!8 = !{!"long", !6, i64 0}
!9 = !{!"_ZTSSt15_Deque_iteratorIiRiPiE", !5, i64 0, !5, i64 8, !5, i64 16, !5, i64 24}
!10 = !{!3, !5, i64 64}
!11 = !{!12, !12, i64 0}
!12 = !{!"int", !6, i64 0}
!13 = !{!3, !8, i64 8}
...
!24 = !{!3, !5, i64 24}
!25 = !{!26, !12, i64 4}
!26 = !{!"_ZTS4Node", !12, i64 0, !12, i64 4}
!27 = !{!26, !12, i64 0}
!28 = !{!29, !12, i64 0}
!29 = !{!"_ZTS4Edge", !12, i64 0, !12, i64 4}
!30 = !{!31, !5, i64 8}
!31 = !{!"_ZTS13pb_Parameters", !5, i64 0, !5, i64 8}
!32 = !{!29, !12, i64 4}
!33 = !{!31, !5, i64 0}
