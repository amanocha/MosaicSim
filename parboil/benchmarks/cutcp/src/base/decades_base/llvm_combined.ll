...
@.str.12.34 = private unnamed_addr constant [2 x i8] c"w\00", align 1
@.str.1.13 = private unnamed_addr constant [25 x i8] c"Cannot open output file\0A\00", align 1
@.str.25 = private unnamed_addr constant [2 x i8] c"a\00", align 1
@.str.1.26 = private unnamed_addr constant [30 x i8] c"error appending to file %s..\0A\00", align 1
@.str.2.27 = private unnamed_addr constant [10 x i8] c"%d  %.3f\0A\00", align 1
@.str.3.28 = private unnamed_addr constant [15 x i8] c"Out of memory\0A\00", align 1
@.str.4.29 = private unnamed_addr constant [26 x i8] c"Expecting one input file\0A\00", align 1
@.str.5.30 = private unnamed_addr constant [25 x i8] c"read_atom_file() failed\0A\00", align 1
@.str.6.31 = private unnamed_addr constant [30 x i8] c"read %d atoms from file '%s'\0A\00", align 1
@str = private unnamed_addr constant [21 x i8] c"extent of domain is:\00", align 1
@.str.8.32 = private unnamed_addr constant [20 x i8] c"  minimum %g %g %g\0A\00", align 1
@.str.9.33 = private unnamed_addr constant [20 x i8] c"  maximum %g %g %g\0A\00", align 1
@.str.10.34 = private unnamed_addr constant [32 x i8] c"padding domain by %g Angstroms\0A\00", align 1
@.str.11.35 = private unnamed_addr constant [35 x i8] c"domain lengths are %g by %g by %g\0A\00", align 1
@.str.13.36 = private unnamed_addr constant [20 x i8] c"Computation failed\0A\00", align 1
@.str.14.37 = private unnamed_addr constant [44 x i8] c"remove_exclusions() failed for cpu lattice\0A\00", align 1
...
for.body:                                         ; preds = %for.inc, %entry
  ...
  %call.i.i = tail call zeroext i1 @_ZNKSt12__basic_fileIcE7is_openEv(%"class.std::__basic_file"* nonnull %_M_file.i.i) #19
...
if.end:                                           ; preds = %if.then.i, %if.then, %for.body
  ...
  %call.i.i26 = tail call zeroext i1 @_ZNKSt12__basic_fileIcE7is_openEv(%"class.std::__basic_file"* nonnull %_M_file.i.i25) #19
...
if.end9:                                          ; preds = %if.then.i36, %if.then6, %if.end
  ...
  %call.i.i39 = tail call zeroext i1 @_ZNKSt12__basic_fileIcE7is_openEv(%"class.std::__basic_file"* nonnull %_M_file.i.i38) #19
...
if.then:                                          ; preds = %entry
  ...
  tail call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), i32 43, i8* getelementptr inbounds ([64 x i8], [64 x i8]* @__PRETTY_FUNCTION__._Z12get_dir_nameSsSsSs, i64 0, i64 0)) #20
  unreachable
...
if.end:                                           ; preds = %_ZNSsD2Ev.exit78, %entry
  ...
  %call.i.i137 = call zeroext i1 @_ZNKSt12__basic_fileIcE7is_openEv(%"class.std::__basic_file"* nonnull %_M_file.i.i136) #19
  br i1 %call.i.i137, label %if.end31, label %if.then30

if.then30:                                        ; preds = %if.end
  call void @__assert_fail(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.10, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), i32 77, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__PRETTY_FUNCTION__.printuBranch, i64 0, i64 0)) #20
  unreachable
...
if.then1:                                         ; preds = %if.then
  ...
  tail call void @__assert_fail(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.10, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), i32 90, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @__PRETTY_FUNCTION__.printMem, i64 0, i64 0)) #20
  unreachable
...
if.then.i.i255:                                   ; preds = %if.then59
  invoke void (i8*, ...) @_ZSt24__throw_out_of_range_fmtPKcz(i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str.26, i64 0, i64 0), i64 %indvars.iv, i64 %sub.ptr.div.i.i.i253) #21
...
if.then.i:                                        ; preds = %if.then
  ...
  %tmp9 = tail call i64 @fwrite(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.23, i64 0, i64 0), i64 16, i64 1, %struct._IO_FILE* %tmp8) #22
...
if.then.i.i:                                      ; preds = %if.end
  ...
  %tmp13 = tail call i64 @fwrite(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.23, i64 0, i64 0), i64 16, i64 1, %struct._IO_FILE* %tmp12) #22
...
if.then.i.i89:                                    ; preds = %if.end26
  ...
  %tmp15 = tail call i64 @fwrite(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.23, i64 0, i64 0), i64 16, i64 1, %struct._IO_FILE* %tmp14) #22
...
if.then.i75:                                      ; preds = %if.else
  ...
  %tmp20 = tail call i64 @fwrite(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.24, i64 0, i64 0), i64 14, i64 1, %struct._IO_FILE* %tmp19) #22
...
error:                                            ; preds = %sw.bb22, %sw.bb, %_ZL15delete_argumentP8argparse.exit
  ...
  %call32 = tail call i32 @fputs(i8* nonnull %err_message.1.ph, %struct._IO_FILE* %tmp27) #23
...
if.then:                                          ; preds = %entry
  ...
  %tmp2 = tail call i64 @fwrite(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.3.19, i64 0, i64 0), i64 42, i64 1, %struct._IO_FILE* %tmp1) #23
  br label %return
...
if.then:                                          ; preds = %entry
  %tmp1 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp2 = tail call i64 @fwrite(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.4.20, i64 0, i64 0), i64 31, i64 1, %struct._IO_FILE* %tmp1) #23
  br label %if.end
...
if.end6:                                          ; preds = %if.end
  ...
  %tmp5 = tail call i64 @fwrite(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.5.21, i64 0, i64 0), i64 34, i64 1, %struct._IO_FILE* %tmp4) #23
...
if.then8:                                         ; preds = %if.end6
  ...
  %tmp7 = tail call i64 @fwrite(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.6.22, i64 0, i64 0), i64 53, i64 1, %struct._IO_FILE* %tmp6) #23
  br label %cleanup
...
if.then:                                          ; preds = %entry
  %tmp1 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp2 = tail call i64 @fwrite(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.7.23, i64 0, i64 0), i64 41, i64 1, %struct._IO_FILE* %tmp1) #23
  br label %cleanup
...
if.then:                                          ; preds = %entry
  %tmp1 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp2 = tail call i64 @fwrite(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.8.24, i64 0, i64 0), i64 31, i64 1, %struct._IO_FILE* %tmp1) #23
  br label %if.end
...
if.end6:                                          ; preds = %if.end
  %tmp4 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp5 = tail call i64 @fwrite(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.9.25, i64 0, i64 0), i64 34, i64 1, %struct._IO_FILE* %tmp4) #23
...
if.then8:                                         ; preds = %if.end6
  %tmp6 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp7 = tail call i64 @fwrite(i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.10.26, i64 0, i64 0), i64 52, i64 1, %struct._IO_FILE* %tmp6) #23
  br label %cleanup
...
if.then:                                          ; preds = %entry
  %tmp1 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp2 = tail call i64 @fwrite(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.11.27, i64 0, i64 0), i64 48, i64 1, %struct._IO_FILE* %tmp1) #23
  br label %if.end
...
entry:
  ...
  %call1 = tail call i64 @strlen(i8* %label) #19
...
if.then.i:                                        ; preds = %if.then18
  %tmp4 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp5 = tail call i64 @fwrite(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.7.23, i64 0, i64 0), i64 41, i64 1, %struct._IO_FILE* %tmp4) #22
  br label %if.end23
...
if.then.i108:                                     ; preds = %if.else20
  %tmp12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp13 = tail call i64 @fwrite(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.7.23, i64 0, i64 0), i64 41, i64 1, %struct._IO_FILE* %tmp12) #22
  br label %if.end23
...
while.body:                                       ; preds = %if.else33, %if.then28
  ...
  %call = tail call i32 @strcmp(i8* %tmp20, i8* nonnull %label) #19
...
if.then.i123:                                     ; preds = %if.then53
  ...
  %tmp24 = tail call i64 @fwrite(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.3.19, i64 0, i64 0), i64 42, i64 1, %struct._IO_FILE* %tmp23) #22
  br label %if.end61
...
if.then.i134:                                     ; preds = %if.else55
  ...
  %tmp30 = tail call i64 @fwrite(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.3.19, i64 0, i64 0), i64 42, i64 1, %struct._IO_FILE* %tmp29) #22
  br label %if.end61
...
if.then.i46:                                      ; preds = %if.then24
  %tmp12 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp13 = tail call i64 @fwrite(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.3.19, i64 0, i64 0), i64 42, i64 1, %struct._IO_FILE* %tmp12) #22
  br label %if.end28
...
if.then.i:                                        ; preds = %for.body
  ...
  %tmp12 = tail call i64 @fwrite(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.11.27, i64 0, i64 0), i64 48, i64 1, %struct._IO_FILE* %tmp11) #22
...
if.then.i87:                                      ; preds = %if.then
  ...
  %tmp18 = tail call i64 @fwrite(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.11.27, i64 0, i64 0), i64 48, i64 1, %struct._IO_FILE* %tmp17) #22
...
while.body:                                       ; preds = %while.body, %if.then14
  ...
  %call19 = tail call i64 @strlen(i8* %tmp20) #19
...
if.then.i94:                                      ; preds = %while.body34
  %tmp23 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp24 = tail call i64 @fwrite(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.11.27, i64 0, i64 0), i64 48, i64 1, %struct._IO_FILE* %tmp23) #22
...
if.then.i101:                                     ; preds = %for.end
  %tmp27 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp28 = tail call i64 @fwrite(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.11.27, i64 0, i64 0), i64 48, i64 1, %struct._IO_FILE* %tmp27) #22
...
if.then.i108:                                     ; preds = %if.then45
  ...
  %tmp32 = tail call i64 @fwrite(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.11.27, i64 0, i64 0), i64 48, i64 1, %struct._IO_FILE* %tmp31) #22
...
; Function Attrs: nounwind uwtable
define dso_local void @_Z21write_lattice_summaryPKcP9Lattice_t(i8* nocapture readonly %filename, %struct.Lattice_t* nocapture readonly %lattice) local_unnamed_addr #5 {
entry:
  %tmp = alloca float, align 4
  %tmp12 = alloca i32, align 4
  %lattice1 = getelementptr inbounds %struct.Lattice_t, %struct.Lattice_t* %lattice, i64 0, i32 1
  %tmp1 = load float*, float** %lattice1, align 8, !tbaa !52
  %nx2 = getelementptr inbounds %struct.Lattice_t, %struct.Lattice_t* %lattice, i64 0, i32 0, i32 0
  %tmp2 = load i32, i32* %nx2, align 8, !tbaa !57
  %ny4 = getelementptr inbounds %struct.Lattice_t, %struct.Lattice_t* %lattice, i64 0, i32 0, i32 1
  %tmp3 = load i32, i32* %ny4, align 4, !tbaa !58
  %nz6 = getelementptr inbounds %struct.Lattice_t, %struct.Lattice_t* %lattice, i64 0, i32 0, i32 2
  %tmp4 = load i32, i32* %nz6, align 8, !tbaa !59
  %call = tail call %struct._IO_FILE* @fopen(i8* %filename, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.12.34, i64 0, i64 0))
  %cmp = icmp eq %struct._IO_FILE* %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %tmp5 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp6 = tail call i64 @fwrite(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1.13, i64 0, i64 0), i64 24, i64 1, %struct._IO_FILE* %tmp5) #23
...
if.end:                                           ; preds = %entry
  ...
  %mul = mul i32 %tmp3, %tmp2
  %mul8 = mul i32 %mul, %tmp4
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %arrayidx = getelementptr inbounds float, float* %tmp1, i64 %indvars.iv
  %tmp8 = load float, float* %arrayidx, align 4, !tbaa !60
  %tmp9 = tail call float @llvm.fabs.f32(float %tmp8)
  %tmp10 = fpext float %tmp9 to double
  %add = fadd double %abspotential.056, %tmp10
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.end:                                          ; preds = %for.end.loopexit, %if.end
  ...
  store float %abspotential.0.lcssa, float* %tmp, align 4, !tbaa !60
  %tmp11 = call i64 @fwrite_unlocked(i8* nonnull %tmp7, i64 1, i64 4, %struct._IO_FILE* nonnull %call)
  ...
  %tmp14 = load i32, i32* %nx2, align 8, !tbaa !57
  %tmp15 = load i32, i32* %ny4, align 4, !tbaa !58
  %mul17 = mul nsw i32 %tmp15, %tmp14
  store i32 %mul17, i32* %tmp12, align 4, !tbaa !23
  %tmp16 = call i64 @fwrite_unlocked(i8* nonnull %tmp13, i64 1, i64 4, %struct._IO_FILE* nonnull %call)
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %tmp13) #3
  %tmp17 = bitcast float* %tmp1 to i8*
  %conv20 = sext i32 %mul to i64
  %tmp18 = tail call i64 @fwrite_unlocked(i8* %tmp17, i64 %conv20, i64 4, %struct._IO_FILE* nonnull %call)
  %sub = add nsw i32 %tmp4, -1
  %mul22 = mul nsw i32 %sub, %mul
  %idx.ext = sext i32 %mul22 to i64
  %add.ptr = getelementptr inbounds float, float* %tmp1, i64 %idx.ext
  %tmp19 = bitcast float* %add.ptr to i8*
  %tmp20 = tail call i64 @fwrite_unlocked(i8* %tmp19, i64 %conv20, i64 4, %struct._IO_FILE* nonnull %call)
...
; Function Attrs: nounwind uwtable
define dso_local i32 @_Z10appenddataPKcid(i8* %filename, i32 %size, double %time) local_unnamed_addr #5 {
entry:
  %call = tail call %struct._IO_FILE* @fopen(i8* %filename, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.25, i64 0, i64 0))
  %cmp = icmp eq %struct._IO_FILE* %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %call1 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.1.26, i64 0, i64 0), i8* %filename)
  br label %cleanup

if.end:                                           ; preds = %entry
  %call2 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* nonnull %call, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2.27, i64 0, i64 0), i32 %size, double %time)
...
define dso_local void @lattice_from_bounding_box(%struct.LatticeDim_t* noalias nocapture sret %agg.result, <2 x float> %lo.coerce0, float %lo.coerce1, <2 x float> %hi.coerce0, float %hi.coerce1, float %h) local_unnamed_addr #17 {
entry:
  ...
  store float %h, float* %h14, align 4, !tbaa !64
  ret void
}
...
; Function Attrs: nounwind uwtable
define dso_local noalias %struct.Lattice_t* @create_lattice(%struct.LatticeDim_t* byval nocapture readonly align 8 %dim) local_unnamed_addr #5 {
entry:
  %call = tail call noalias i8* @malloc(i64 40) #3
  %tmp = bitcast i8* %call to %struct.Lattice_t*
  %cmp = icmp eq i8* %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %tmp1 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp2 = tail call i64 @fwrite(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3.28, i64 0, i64 0), i64 14, i64 1, %struct._IO_FILE* %tmp1) #23
  tail call void @exit(i32 1) #20
  unreachable

if.end:                                           ; preds = %entry
  %tmp3 = bitcast %struct.LatticeDim_t* %dim to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 %call, i8* nonnull align 8 %tmp3, i64 28, i1 false), !tbaa.struct !65
  %nx = getelementptr inbounds %struct.LatticeDim_t, %struct.LatticeDim_t* %dim, i64 0, i32 0
  %tmp4 = load i32, i32* %nx, align 8, !tbaa !61
  %ny = getelementptr inbounds %struct.LatticeDim_t, %struct.LatticeDim_t* %dim, i64 0, i32 1
  %tmp5 = load i32, i32* %ny, align 4, !tbaa !62
  %mul = mul nsw i32 %tmp5, %tmp4
  %nz = getelementptr inbounds %struct.LatticeDim_t, %struct.LatticeDim_t* %dim, i64 0, i32 2
  %tmp6 = load i32, i32* %nz, align 8, !tbaa !63
  %mul3 = mul nsw i32 %mul, %tmp6
  %add = add nsw i32 %mul3, 7
  %and = and i32 %add, -8
  %conv = sext i32 %and to i64
  %call4 = tail call noalias i8* @calloc(i64 %conv, i64 4) #3
  %lattice = getelementptr inbounds i8, i8* %call, i64 32
  %tmp7 = bitcast i8* %lattice to i8**
  store i8* %call4, i8** %tmp7, align 8, !tbaa !52
  %cmp6 = icmp eq i8* %call4, null
  br i1 %cmp6, label %if.then7, label %if.end9

if.then7:                                         ; preds = %if.end
  %tmp8 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp9 = tail call i64 @fwrite(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3.28, i64 0, i64 0), i64 14, i64 1, %struct._IO_FILE* %tmp8) #23
  tail call void @exit(i32 1) #20
  unreachable

if.end9:                                          ; preds = %if.end
  ret %struct.Lattice_t* %tmp
}
...
; Function Attrs: nounwind uwtable
define dso_local void @destroy_lattice(%struct.Lattice_t* %lat) local_unnamed_addr #5 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %tmp = bitcast float** %lattice to i8**
  %tmp1 = load i8*, i8** %tmp, align 8, !tbaa !52
  tail call void @free(i8* %tmp1) #3
  %tmp2 = bitcast %struct.Lattice_t* %lat to i8*
  tail call void @free(i8* %tmp2) #3
  br label %if.end
...
define dso_local i32 @main(i32 %argc, i8** %argv) local_unnamed_addr #18 {
entry:
  ...
  %tmp = bitcast %struct.Vec3_t* %min_ext to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %tmp) #3
  %tmp1 = bitcast %struct.Vec3_t* %max_ext to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %tmp1) #3
  %tmp2 = bitcast %struct.pb_TimerSet* %timers to i8*
  call void @llvm.lifetime.start.p0i8(i64 288, i8* nonnull %tmp2) #3
...
if.then3:                                         ; preds = %if.end
  ...
  %tmp4 = call i64 @fwrite(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.4.29, i64 0, i64 0), i64 25, i64 1, %struct._IO_FILE* %tmp3) #23
  call void @exit(i32 1) #20
  unreachable
...
if.end5:                                          ; preds = %if.end
  ...
  %tmp5 = load i8**, i8*** %inpFiles, align 8, !tbaa !29
  %tmp6 = load i8*, i8** %tmp5, align 8, !tbaa !26
  %call6 = call %struct.Atoms_t* @read_atom_file(i8* %tmp6)
  %tobool = icmp eq %struct.Atoms_t* %call6, null
  br i1 %tobool, label %if.then7, label %if.end9

if.then7:                                         ; preds = %if.end5
  %tmp7 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp8 = call i64 @fwrite(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.5.30, i64 0, i64 0), i64 24, i64 1, %struct._IO_FILE* %tmp7) #23
  call void @exit(i32 1) #20
  unreachable

if.end9:                                          ; preds = %if.end5
  %size = getelementptr inbounds %struct.Atoms_t, %struct.Atoms_t* %call6, i64 0, i32 1
  %tmp9 = load i32, i32* %size, align 8, !tbaa !66
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.6.31, i64 0, i64 0), i32 %tmp9, i8* %tmp6)
  ...
  %tmp10 = load float, float* %x, align 4, !tbaa !68
  %conv = fpext float %tmp10 to double
  %y = getelementptr inbounds %struct.Vec3_t, %struct.Vec3_t* %min_ext, i64 0, i32 1
  %tmp11 = load float, float* %y, align 4, !tbaa !69
  %conv12 = fpext float %tmp11 to double
  %z = getelementptr inbounds %struct.Vec3_t, %struct.Vec3_t* %min_ext, i64 0, i32 2
  %tmp12 = load float, float* %z, align 4, !tbaa !70
  %conv13 = fpext float %tmp12 to double
  %call14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.8.32, i64 0, i64 0), double %conv, double %conv12, double %conv13)
  %x15 = getelementptr inbounds %struct.Vec3_t, %struct.Vec3_t* %max_ext, i64 0, i32 0
  %tmp13 = load float, float* %x15, align 4, !tbaa !68
  %conv16 = fpext float %tmp13 to double
  %y17 = getelementptr inbounds %struct.Vec3_t, %struct.Vec3_t* %max_ext, i64 0, i32 1
  %tmp14 = load float, float* %y17, align 4, !tbaa !69
  %conv18 = fpext float %tmp14 to double
  %z19 = getelementptr inbounds %struct.Vec3_t, %struct.Vec3_t* %max_ext, i64 0, i32 2
  %tmp15 = load float, float* %z19, align 4, !tbaa !70
  %conv20 = fpext float %tmp15 to double
  %call21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.9.33, i64 0, i64 0), double %conv16, double %conv18, double %conv20)
  %call23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.10.34, i64 0, i64 0), double 5.000000e-01)
  %tmp16 = load float, float* %x, align 4, !tbaa !68
  %sub = fadd float %tmp16, -5.000000e-01
  %tmp17 = load float, float* %y, align 4, !tbaa !69
  %sub28 = fadd float %tmp17, -5.000000e-01
  %tmp18 = load float, float* %z, align 4, !tbaa !70
  %sub31 = fadd float %tmp18, -5.000000e-01
  %tmp19 = load float, float* %x15, align 4, !tbaa !68
  %add = fadd float %tmp19, 5.000000e-01
  %tmp20 = load float, float* %y17, align 4, !tbaa !69
  %add37 = fadd float %tmp20, 5.000000e-01
  %tmp21 = load float, float* %z19, align 4, !tbaa !70
  %add40 = fadd float %tmp21, 5.000000e-01
  ...
  %call53 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.11.35, i64 0, i64 0), double %conv44, double %conv48, double %conv52)
  %div.i = fmul float %sub43, 2.000000e+00
  %tmp22 = call float @llvm.floor.f32(float %div.i) #3
  %conv.i = fptosi float %tmp22 to i32
  %add.i = add nsw i32 %conv.i, 1
  %div5.i = fmul float %sub47, 2.000000e+00
  %tmp23 = call float @llvm.floor.f32(float %div5.i) #3
  %conv6.i = fptosi float %tmp23 to i32
  %add7.i = add nsw i32 %conv6.i, 1
  %div10.i = fmul float %sub51, 2.000000e+00
  %tmp24 = call float @llvm.floor.f32(float %div10.i) #3
  %conv11.i = fptosi float %tmp24 to i32
  %add12.i = add nsw i32 %conv11.i, 1
  %call.i = call noalias i8* @malloc(i64 40) #3
  %tmp25 = bitcast i8* %call.i to %struct.Lattice_t*
  %cmp.i = icmp eq i8* %call.i, null
  br i1 %cmp.i, label %if.then.i127, label %if.end.i

if.then.i127:                                     ; preds = %if.end9
  %tmp26 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp27 = call i64 @fwrite(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3.28, i64 0, i64 0), i64 14, i64 1, %struct._IO_FILE* %tmp26) #22
  call void @exit(i32 1) #20
  unreachable
...
if.end.i:                                         ; preds = %if.end9
  ...
  %call4.i = call noalias i8* @calloc(i64 %conv.i132, i64 4) #3
  %lattice.i133 = getelementptr inbounds i8, i8* %call.i, i64 32
  %tmp28 = bitcast i8* %lattice.i133 to i8**
  store i8* %call4.i, i8** %tmp28, align 8, !tbaa !52
  %cmp6.i = icmp eq i8* %call4.i, null
  br i1 %cmp6.i, label %if.then7.i, label %create_lattice.exit

if.then7.i:                                       ; preds = %if.end.i
  %tmp29 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp30 = call i64 @fwrite(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3.28, i64 0, i64 0), i64 14, i64 1, %struct._IO_FILE* %tmp29) #22
  call void @exit(i32 1) #20
  unreachable

create_lattice.exit:                              ; preds = %if.end.i
  %putchar = call i32 @putchar(i32 10)
  %call59 = call i32 @cpu_compute_cutoff_potential_lattice(%struct.Lattice_t* nonnull %tmp25, float 1.200000e+01, %struct.Atoms_t* nonnull %call6)
  %tobool60 = icmp eq i32 %call59, 0
  br i1 %tobool60, label %if.end63, label %if.then61

if.then61:                                        ; preds = %create_lattice.exit
  %tmp31 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp32 = call i64 @fwrite(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.13.36, i64 0, i64 0), i64 19, i64 1, %struct._IO_FILE* %tmp31) #23
  call void @exit(i32 1) #20
  unreachable

if.end63:                                         ; preds = %create_lattice.exit
  %call64 = call i32 @remove_exclusions(%struct.Lattice_t* nonnull %tmp25, float 1.000000e+00, %struct.Atoms_t* nonnull %call6)
  %tobool65 = icmp eq i32 %call64, 0
  br i1 %tobool65, label %if.end68, label %if.then66

if.then66:                                        ; preds = %if.end63
  %tmp33 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !26
  %tmp34 = call i64 @fwrite(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.14.37, i64 0, i64 0), i64 43, i64 1, %struct._IO_FILE* %tmp33) #23
  call void @exit(i32 1) #20
  unreachable
...
if.end68:                                         ; preds = %if.end63
  ...
  %tmp35 = load i8*, i8** %outFile, align 8, !tbaa !27
  %tobool69 = icmp eq i8* %tmp35, null
  br i1 %tobool69, label %destroy_lattice.exit, label %if.then70

if.then70:                                        ; preds = %if.end68
  call void @write_lattice_summary(i8* nonnull %tmp35, %struct.Lattice_t* nonnull %tmp25)
  br label %destroy_lattice.exit

destroy_lattice.exit:                             ; preds = %if.then70, %if.end68
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %timers, i32 6)
  %tmp36 = load i8*, i8** %tmp28, align 8, !tbaa !52
  call void @free(i8* %tmp36) #3
  call void @free(i8* nonnull %call.i) #3
  ...
  call void @llvm.lifetime.end.p0i8(i64 288, i8* nonnull %tmp2) #3
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %tmp1) #3
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %tmp) #3
  call void @tracer_cleanup()
  ret i32 0
}

declare dso_local %struct.Atoms_t* @read_atom_file(i8*) local_unnamed_addr #1

declare dso_local void @get_atom_extent(%struct.Vec3_t*, %struct.Vec3_t*, %struct.Atoms_t*) local_unnamed_addr #1
...
declare dso_local i32 @cpu_compute_cutoff_potential_lattice(%struct.Lattice_t*, float, %struct.Atoms_t*) local_unnamed_addr #1

declare dso_local i32 @remove_exclusions(%struct.Lattice_t*, float, %struct.Atoms_t*) local_unnamed_addr #1

declare dso_local void @write_lattice_summary(i8*, %struct.Lattice_t*) local_unnamed_addr #1

declare dso_local void @free_atom(%struct.Atoms_t*) local_unnamed_addr #1
...
attributes #17 = { nounwind uwtable writeonly "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="64" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #18 = { norecurse uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="64" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!51 = !{!50, !13, i64 0}
!52 = !{!53, !13, i64 32}
!53 = !{!"_ZTS9Lattice_t", !54, i64 0, !13, i64 32}
!54 = !{!"_ZTS12LatticeDim_t", !15, i64 0, !15, i64 4, !15, i64 8, !55, i64 12, !56, i64 24}
!55 = !{!"_ZTS6Vec3_t", !56, i64 0, !56, i64 4, !56, i64 8}
!56 = !{!"float", !4, i64 0}
!57 = !{!53, !15, i64 0}
!58 = !{!53, !15, i64 4}
!59 = !{!53, !15, i64 8}
...
!63 = !{!54, !15, i64 8}
!64 = !{!54, !56, i64 24}
!65 = !{i64 0, i64 4, !23, i64 4, i64 4, !23, i64 8, i64 4, !23, i64 12, i64 4, !60, i64 16, i64 4, !60, i64 20, i64 4, !60, i64 24, i64 4, !60}
!66 = !{!67, !15, i64 8}
!67 = !{!"_ZTS7Atoms_t", !13, i64 0, !15, i64 8}
!68 = !{!55, !56, i64 0}
!69 = !{!55, !56, i64 4}
!70 = !{!55, !56, i64 8}
